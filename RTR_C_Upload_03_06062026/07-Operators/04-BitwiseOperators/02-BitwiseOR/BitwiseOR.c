...
int main(void)
{
    ...
    printf("\n============================================================\n\n");
    result = x | y;
    printf("Bitwise OR-ing Of \n x = %d (Decimal) and y = %d (Decinal) gives result %d (Decimal).\n\n", x, y, result);
...
// ****** BEGINNERS TO C PROGRAMMING LANGUAGE : PLEASE IGNORE THE CODE OF THE FOLLOWING FUNCTION SNIPPET 'PrintBinaryFormOfNumer()' ******
