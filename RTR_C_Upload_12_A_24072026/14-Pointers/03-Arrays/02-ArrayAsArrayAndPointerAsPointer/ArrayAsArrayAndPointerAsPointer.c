// Program Name : ArrayAsArrayAndPinterAsPointer.c
...
int main(void)
{
	...
	int integerArray[] = { 11, 22, 33, 44, 55, 66, 77, 88, 99, 110 }; // Integer Array
	int* ptr_integerArray = NULL;  // Integer Pointer

	// Code
	// #### Using Array Name As  A Array i.e. Value Of xth Element Of integerArray : integerArray[x] And Address Of xth
	// Element Of integerArray : &integerArray[x] ##########
	printf("\n==================================================================\n");
	printf("**** Using Array Name As A Array i.e. : Value Of xth Element Of integerArray : integerArray[x] And Address of xth Element of integerArray : &integerArray[x] ***** \n\n");
	...
	printf("integerArray[1] = %d        At Address &integerArray[0] : %p\n", integerArray[1], &integerArray[1]);
	printf("integerArray[2] = %d        At Address &integerArray[0] : %p\n", integerArray[2], &integerArray[2]);
	printf("integerArray[3] = %d        At Address &integerArray[0] : %p\n", integerArray[3], &integerArray[3]);
	printf("integerArray[4] = %d        At Address &integerArray[0] : %p\n", integerArray[4], &integerArray[4]);
	printf("integerArray[5] = %d        At Address &integerArray[0] : %p\n", integerArray[5], &integerArray[5]);
	printf("integerArray[6] = %d        At Address &integerArray[0] : %p\n", integerArray[6], &integerArray[6]);
	printf("integerArray[7] = %d        At Address &integerArray[0] : %p\n", integerArray[7], &integerArray[7]);
	printf("integerArray[8] = %d        At Address &integerArray[0] : %p\n", integerArray[8], &integerArray[8]);
	printf("integerArray[9] = %d       At Address &integerArray[0] : %p\n", integerArray[9], &integerArray[9]);


	// Assigning Base Address Of Integer Arrray 'integerArray' To Integer Pointer 'ptr_integerArray'
	// Name Of Any Array Is Its Own Base Address
	ptr_integerArray = integerArray; // Same As .... ptr_integerArray = &integerArray[0]

	// ######## Using Pointer As Pointer i.e. : Value Of xth Element Of integerArray : *(ptr_integerArray + x) 
	// And Address Of xth Element Of integerArray : (ptr_integerArray + x) #####
	printf("\n==================================================================\n");
	printf("*** Using Pointer As Pointer i.e. Value Of xth Element Of integerArray : *(ptr_integerArray + x) And Address Of xth Element OF integerArray : (ptr_integerArray + x) ******\n\n");
	printf("Integer Array Elements And Their Addresses : \n\n");
